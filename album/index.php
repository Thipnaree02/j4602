...
if(isset($_POST['Submit'])){
    ...
    $sql = "SELECT * FROM admin WHERE a_usr='{$_POST['usr']}'";
    ...
    if($num > 0){
        ...
        // ใช้ password_verify() ในการตรวจสอบรหัสผ่านที่ผู้ใช้กรอก
        if(password_verify($_POST['pwd'], $data['a_pwd'])){
            $_SESSION['s_id'] = $data['a_id'];
            $_SESSION['s_name'] = $data['a_name'];
            echo "<script>";
